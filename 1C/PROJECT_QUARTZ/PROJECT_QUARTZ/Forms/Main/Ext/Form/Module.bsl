...
&НаСервере
Процедура Выполнить_ТНаСервере(ДанныеФормы, Раздел)
	...
	ЗаписатьМассивСостоянийОбъектаВJSON(МассивСостояний);
...
Процедура Выполнить_Т(Команда)
	...
	Попытка
		...
		Выполнить_ТНаСервере(ДанныеФормы, Раздел);	
...
Функция ЗаписатьСостояниеОбъекта(Об, Массив)
	...
	Для каждого Реквизит Из Об.Метаданные().Реквизиты Цикл
		...
		СтруктураОбъекта.Вставить(Реквизит.Имя, Об[Реквизит.Имя]);		
	...
	Для каждого ТЧ Из Об.Метаданные().ТабличныеЧасти Цикл
		...
		Для каждого СтрТЧ Из Об[ТЧ.Имя] Цикл
			...
			Для каждого Реквизит Из ТЧ.Реквизиты Цикл
				...
				СтруктураТЧ.Вставить(Реквизит.Имя, СтрТЧ[Реквизит.Имя]); 	
...
&НаСервере
Процедура ЗаписатьМассивСостоянийОбъектаВJSON(Массив)
	...
	ЗаписатьJSON(ЗаписьJSON, Массив, Новый НастройкиСериализацииJSON);
	ЗаписьJSON.Закрыть();			
